...
function renderRarefactionCurves(abundancesObj) {
    ...
    var xValue = function(d) {
        ...
        xMap = function(d, i) { return xScale(xValue(d, i));},
        xAxis = d3.svg.axis().scale(xScale).orient("bottom");

    // setup y
    var yValue = function(d) { return d.v;},
        ...
        .enter().append("circle")
          ...
          .on("mouseover", function(d) {
            tooltip.transition()
                .duration(100)
                .style("opacity", 1);
            tooltip.html("<strong>" + sampleID + "</strong><br />Subsample: <strong>" + d.h + "</strong><br />Value: <strong>" + d.v + "</strong>")
