...
class TestFisherExact(unittest.TestCase):
    ...
    def test_simple_fisher_exact(self):
        ...
        user_request.set_custom_attr("pvalthreshold", 1.1)
        ...
        self.assertEquals(50, len(actual_output["training_indexes"]))
        del actual_output["training_indexes"]
        del actual_output["hints"]
